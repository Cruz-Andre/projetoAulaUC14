...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../styles/stylesTecAdm.css">
...
<body id="s1">
			...
			<ul class="cabecalhoLista">
				...
				<?php 
					if (isset($_SESSION['nome_usu_sessao'])) {
						echo '<li class="cabecalhoItem"><a class="cabecalhoItemLink" href="./tecAdm.php?logout">User: '.$_SESSION['nome_usu_sessao'].' Sair</a></li>';
					} else {
    ...
    <section class="contPrin">
        <div>
            ...
            <h3>Curso técnico de 1000 horas</h3>
            <p><img src="../img/tecADM.jfif" alt="Técnico em Administração" width="400"
                    title="Técnico em Administração"></p>
        ...
        <div class="textoPrinc">
            ...
            <p>
                Uma aprendizagem pautada por metodologias que propiciam atuação por projetos, aulas práticas, teóricas,
                vivenciais e flexíveis com foco no mercado de trabalho.
            </p>

            <p>
                Também, momentos mediados por tecnologia**, em uma plataforma educacional própria, com conteúdo
                produzido por tutores altamente qualificados.
            </p>
            ...
            <strong>
                ...
                <p>Total de horas do curso: 1.000h</p>
                <p>- Momentos presenciais*: 844h</p>
                <p>- Momentos mediados por tecnologias com tutoria ativa**: 156h (no formato EAD - Educação a Distância)
                </p>
            </strong>
        </div>
        ...
        <div class="textFim">
            <p>Ao final da formação você estará apto a atuar em empresas de diversos segmentos, além de poder participar
                de concursos em organizações públicas.</p>
            <p>Gostou da ideia de ser um profissional completo da área Administrativa? Venha para o curso Técnico em
                Administração do Senac-RS e mude de vida.</p>
        </div>
        ...
        <div class="programa">
            ...
            <ul type="circle">
                <li>
                    <h3>Auxiliar na elaboração, implementação e acompanhamento do planejamento estratégico das
                        organizações;</h3>
                </li>
                <li>
                    <h3>Elaborar, organizar e controlar documentos da organização;</h3>
                </li>
                <li>
                    <h3>Auxiliar na estruturação e operacionalização de projetos;</h3>
                </li>
                <li>
                    <h3>Auxiliar a execução dos procedimentos de recrutamento, seleção e integração de pessoas;</h3>
                </li>
                <li>
                    <h3>Apoiar e executar ações pertinentes a desenvolvimento de pessoas, retenção, avaliação de
                        desempenho e elaboração de planos de cargos e salários;</h3>
                </li>
                <li>
                    <h3>Atuar na organização e execução de ações relacionadas à qualidade de vida, saúde e segurança nos
                        ambientes de trabalho;</h3>
                </li>
                <li>
                    <h3>Apoiar e executar ações referentes às rotinas de admissão e demissão de colaboradores;</h3>
                </li>
                <li>
                    <h3>Auxiliar na elaboração da folha de pagamento;</h3>
                </li>
                <li>
                    <h3>Auxiliar a execução das ações pertinentes aos processos de gestão de materiais e patrimônio em
                        organizações;</h3>
                </li>
                <li>
                    <h3>Auxiliar na execução de atividades relacionadas às operações logísticas em organizações.</h3>
                </li>
            </ul>
        </div>
        ...
        <table class="tableTurma">
            ...
            <tbody>
                <tr>
                    ...
                    <td rowspan="2">
                        <h3>03/10/2023 até 04/03/2024</h3>
                    </td>
                    <td rowspan="2">
                        <h3>04/03/2024</h3>
                    </td>
                    <td rowspan="2">
                        <h3>04/03/2024 até 28/08/2025</h3>
                    </td>
                    <td>
